...
class Person2 extends Person{
 public Person2(String name, int countOfNiva, String fatherName, Home home) {
     super(name, countOfNiva, fatherName, home) ;
 }
...
public class Person implements Serializable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Person2 igor = new Person2("Igor", 2, "Raphael", home);
        Person2 renat = new Person2("Renat", 2, "Raphael", home);
...
System.out.println("class after:  "+renatRestoredFromByte.getClass().getName());
    }
}
